...
dt_create = Annotated[datetime, mapped_column(DateTime, default=_utc_now)]
dt_update = Annotated[datetime, mapped_column(DateTime, default=_utc_now, onupdate=_utc_now)]
...
_PAXMINER_SCHEMA = os.environ.get("PAXMINER_SCHEMA", "paxminer")
