-- Local dev bootstrap SQL. Names must match your env:
--   PAXMINER_SCHEMA (default paxminer)
--   ADMIN_DATABASE_SCHEMA (default slackblast)
--   LOCAL_DEV_REGION_SCHEMA (default f3devregion)
