...
_DEFAULT_REGION_TZ = os.environ.get("TIMEZONE", "US/Central")
...
class Region(BaseClass, QSignupClass):
  ...
  timezone = Column("timezone", String(45), default=_DEFAULT_REGION_TZ)
  created = Column('created', DateTime, default=utc_now)
  updated = Column('updated', DateTime, default=utc_now)
