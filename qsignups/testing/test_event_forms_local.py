...
def test_build_open_slot_assignment_view_defaults_to_current_user() -> None:
    from slack import actions
    from slack.forms import event

    view = event.build_open_slot_assignment_view(
        "The Bridge",
    ...
    assert view["blocks"][3]["elements"][0]["action_id"] == actions.SUBMIT_ASSIGN_OPEN_SLOT_ACTION
...
if __name__ == "__main__":
    test_build_open_slot_assignment_view_defaults_to_current_user()
