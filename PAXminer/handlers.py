"""
AWS Lambda entry points for PAXminer user/channel sync, achievements
(daily + webhook), and the unified schedule dispatcher.

Slack interactivity (/config-paxminer and config modals) lives in slack_app.py
on the lightweight SlackFunction. Monthly charts and Kotter reports are owned
by the schedule dispatcher (schedule_handler / ScheduleFunction).
"""
